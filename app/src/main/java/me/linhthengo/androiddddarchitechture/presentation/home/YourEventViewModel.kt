...
import me.linhthengo.androiddddarchitechture.aplication.home.YourEvent
...
class YourEventViewModel@Inject constructor(private val yourEvent: YourEvent) : BaseViewModel() {
    sealed class State {
    ...
    fun yourEvent() = viewModelScope.launch {
        yourEvent(null,this) {
